...
func (web *Web) newHandler() http.Handler {
	...
	router.HandleFunc("/setup/arena", web.arenaMasterPageHandler).Methods("GET")
	router.HandleFunc("/api/arena-master/status", web.arenaMasterStatusHandler).Methods("GET")
	router.HandleFunc("/api/arena-master/password", web.arenaMasterPasswordHandler).Methods("POST")
	router.HandleFunc("/api/arena-master/connect", web.arenaMasterConnectHandler).Methods("POST")
	router.HandleFunc("/api/arena-master/check", web.arenaMasterCheckHandler).Methods("POST")
	router.HandleFunc("/api/arena-master/register", web.arenaMasterRegisterHandler).Methods("POST")
	router.HandleFunc("/api/arena-master/apply", web.arenaMasterApplyHandler).Methods("POST")
	router.HandleFunc("/api/arena-master/reset", web.arenaMasterResetHandler).Methods("POST")
	router.HandleFunc("/api/arena-master/sync-now", web.arenaMasterSyncNowHandler).Methods("POST")
