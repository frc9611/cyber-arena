...
const overlayCenteringTopHideParams = {queue: false, display: "none", visibility: "hidden"};
const overlayCenteringTopShowParams = {queue: false, top: "50px", display: "flex", visibility: "visible"};
