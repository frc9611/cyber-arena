...
var addBluePoints = function(points, modeId) { // 1 = AUTO ; 2 = TELEOP ; 3 = END_GAME
...
var addRedPoints = function(points, modeId) { // 1 = AUTO ; 2 = TELEOP ; 3 = END_GAME
...
var commitResults = function() {
  var box = $("#isOfficialMatch");
  var official = box.length === 0 || box.prop("checked");
...
var handleArenaStatus = function(data) {
  ...
  switch (matchStates[data.MatchState]) {
    case "PRE_MATCH":
      ...
      $(".cr-btn-score").prop("disabled", true);
      break;
    case "START_MATCH":
    case "WARMUP_PERIOD":
    case "AUTO_PERIOD":
    ...
    case "TELEOP_PERIOD":
      ...
      $(".cr-btn-score").prop("disabled", false);
      break;
    case "POST_MATCH":
      $("#startMatch").prop("disabled", true);
      $("#abortMatch").prop("disabled", true);
